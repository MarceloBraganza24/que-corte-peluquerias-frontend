...
const ShiftsList = () => {
    ...
    const ayrtonObjetosFiltrados = objetosFiltrados.filter(shift => shift.hairdresser == 'Ayrton');
    const ayrtonObjetosFiltradosByNotCancel = ayrtonObjetosFiltrados.filter(shift => shift.cancelled != true);
    
    const mirkoObjetosFiltrados = objetosFiltrados.filter(shift => shift.hairdresser == 'Mirko');
    const mirkoObjetosFiltradosByNotCancel = mirkoObjetosFiltrados.filter(shift => shift.cancelled != true);
    
    const aleObjetosFiltrados = objetosFiltrados.filter(shift => shift.hairdresser == 'Ale');
    const aleObjetosFiltradosByNotCancel = aleObjetosFiltrados.filter(shift => shift.cancelled != true);
                    ...
                    <div className='shiftsListContainer__selectHairdresser-title'>
                        <div className='shiftsListContainer__selectHairdresser-title__selectHairdresser'>
                            <div className='shiftsListContainer__selectHairdresser-title__selectHairdresser__label'>Peluquero:</div>
                            {
                                ...
                                <select className='shiftsListContainer__selectHairdresser-title__selectHairdresser__select' value={selectOptionHeaderHairdresserShL} onChange={(e) => {handleSelectOptionHeaderHairdresserShL(e.target.value)}}>
                                    {optionsHairdresser.map((option, index) => (
                                    <option key={index} value={option}>{option}</option>
                                    ))}
                                </select>
                                :
                                <select disabled style={selectDisabledStyle} className='shiftsListContainer__selectHairdresser-title__selectHairdresser__select' value={selectOptionHeaderHairdresserShL} onChange={(e) => {handleSelectOptionHeaderHairdresserShL(e.target.value)}}>
                                    {optionsHairdresser.map((option, index) => (
                                    <option key={index} value={option}>{option}</option>
                                    ))}
                                </select>
                        ...
                        <div className='itemCreateShift'>
                            {
                                ...
                                <>
                                    ...
                                    <div className='itemCreateShift__btns'>
                                        ...
                                        <div className='itemCreateShift__btns__cancelDay'>
                                            <button id='btnCreateShift' className='itemCreateShift__btns__createCancelShift__btn' onClick={handleBtnCreateShift}>Crear turno</button>
                                            {showSpinner&&<Spinner/>}
                                        </div>
                                    </div>
                                </>
                                ...
                                <>
                                    ...
                                    <div className='itemCreateShift__btns'>
                                        ...
                                        <div className='itemCreateShift__btns__cancelDay'>
                                            <button style={buttonDisabledStyle} disabled id='btnCreateShift' className='itemCreateShift__btns__createCancelShift__btn' onClick={handleBtnCreateShift}>Crear turno</button>
                                        </div>
                                        {showSpinner&&<Spinner/>}
                                    </div>
                                </>
