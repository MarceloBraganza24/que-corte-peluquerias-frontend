                    ...
                    <div className='usersListContainer__inputFilteredUsers'>
                        {
                            ...
                            :
                            <input disabled style={buttonDisabledStyle} className='usersListContainer__inputFilteredUsers__prop' placeholder='Ingrese un apellido'/>
                        }
                    </div>
