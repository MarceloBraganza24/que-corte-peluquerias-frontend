                    ...
                    <div className='partnersContainerIsLoggedIn'>
                        <div className='partnersContainerIsLoggedIn__userName'>
                        ...
                        </div>
                            {
                                ...
                                <h2 className='partnersContainerIsLoggedIn__phrase' style={{borderBottom:'0.3vh solid white'}}>Ya eres socio/a en Que Corte</h2>
                                :
                                ...
                                <div className='partnersContainerIsLoggedIn__payMembershipFeeContainer__labels-btn__btn'>
                                    {
                                            ...
                                            !deleteTicketModal?
                                                <>
                                                    <button id='btnPayMembershipFee' style={{width:'250px',backgroundColor:'#d2b569'}} className='partnersContainerIsLoggedIn__payMembershipFeeContainer__labels-btn__btn__prop'>Aún no puedes pagar la cuota</button>
                                                </>
                                                :
                                                <button id='btnPayMembershipFee' style={{width:'250px',backgroundColor:'#d2b569'}} className='partnersContainerIsLoggedIn__payMembershipFeeContainer__labels-btn__btn__prop'>Aún no puedes pagar la cuota</button>
