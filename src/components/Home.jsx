        ...
        <>
            ...
            <div className='homeContainer'>
              <div className='homeContainer__imgContainer'>
                ...
                <div className='homeContainer__imgContainer__img'>
                  <img src="https://storage.googleapis.com/que-corte-peluquerias-img/maquinas.jpeg" className='homeContainer__imgContainer__img__prop' alt="imagenPeluqueria"/>
                </div>
                <div className='homeContainer__imgContainer__img'>
                  <img src="https://storage.googleapis.com/que-corte-peluquerias-img/tijeras.jpeg" className='homeContainer__imgContainer__img__prop' alt="imagenPeluqueria"/>
                </div>
              </div>
            </div>
          </> 
